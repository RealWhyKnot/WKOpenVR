...
public:
	...
	// connected; drains overlay events into ImGuiIO. Returns true when the
	// real SteamVR dashboard overlay is currently visible.
	bool TickFrame(int overlayPixelWidth, int overlayPixelHeight);

	// Hand the umbrella's offscreen FBO texture to the VR overlay.
