...
const ThemeDef kThemes[] = {
    ...
    {ThemeId::Light, "Light", "Light backgrounds. For bright rooms or screenshots.", &LightPalette,
     &ApplyLightImGuiColors},
    {ThemeId::HighContrast, "High Contrast", "Pure black, white text and borders. Accessibility.", &HighContrastPalette,
     &ApplyHighContrastImGuiColors},
    {ThemeId::PureDark, "Pure Dark", "True-black backgrounds. Friendly to OLED displays.", &PureDarkPalette,
     &ApplyPureDarkImGuiColors},
};
