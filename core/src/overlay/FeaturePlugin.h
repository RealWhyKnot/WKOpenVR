...
protected:
	...
	static const char* ModuleName(ModuleId id) { return openvr_pair::common::modules::DisplayName(id); }

	static const char* ModuleFlagFileName(ModuleId id) { return openvr_pair::common::modules::FlagFileName(id); }

	static const char* ModulePipeName(ModuleId id) { return openvr_pair::common::modules::PipeName(id); }
};

inline bool ShouldShowInModulesTab(FeaturePluginChannel channel)
{
	return channel == FeaturePluginChannel::Release || channel == FeaturePluginChannel::Development;
}
