...
private:
	...
	static void SmoothScalar(float& value, ScalarFilter& state, uint8_t strength, float dt_sec);
	static void SmoothVec3(float value[3], Vec3Filter& state, uint8_t strength, float dt_sec);
};
