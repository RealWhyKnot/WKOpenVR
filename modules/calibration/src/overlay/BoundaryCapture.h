...
public:
	...
	FloorHitPreview PreviewControllerFloorHit(const Eigen::Affine3d& controllerPose, double floorY = 0.0) const;
	FloorHitPreview PreviewPointerFloorHit(const Eigen::Affine3d& pointerPose, double floorY = 0.0) const;
...
private:
	...
	bool AppendProjection(const Eigen::Affine3d& poseForLog, bool triggerHeld, double floorY, bool pointerOnly);
	bool AppendProjectedPosition(const Eigen::Affine3d& controllerPose, bool active, double floorY);
