...
public:
	...
	bool Observe(const Eigen::Affine3d& rawPose, int deviceId, const std::string& trackingSystem);
...
std::vector<BoundaryVertex> BuildFloorMarkerVertices(const Eigen::Affine3d& pose, double floorY,
