...
TEST(CommonModeCoherenceTest, EvenCountMedianIsUpperMiddle)
{
	...
	EXPECT_NEAR(cm::ComputeCoherenceScore(10.0, {2.0, 4.0, 6.0, 8.0}), 0.6, 1e-9);
}
...
static_assert(cm::kSuppressThreshold == 0.70, "kSuppressThreshold changed -- review the bias-toward-firing rationale "
                                              "in CommonModeCoherence.h before relaxing or tightening");
static_assert(cm::kMinExtrasForCoherence == 1, "kMinExtrasForCoherence changed -- single-extra sessions are the "
