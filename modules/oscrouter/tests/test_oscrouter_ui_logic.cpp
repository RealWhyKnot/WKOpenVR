...
{
    EXPECT_EQ(
        oscrouter::ui::ResolveDriverPanelState(false, false, false),
...
{
    EXPECT_EQ(
        oscrouter::ui::ResolveDriverPanelState(true, true, false),
        oscrouter::ui::DriverPanelState::Active);
}

TEST(OscRouterUiLogic, WaitsForDriverBeforeSurfacingProblem)
{
    EXPECT_EQ(
        oscrouter::ui::ResolveDriverPanelState(true, false, false),
        oscrouter::ui::DriverPanelState::WaitingForDriver);
    EXPECT_EQ(
        oscrouter::ui::ResolveDriverPanelState(true, false, true),
        oscrouter::ui::DriverPanelState::Problem);
}
