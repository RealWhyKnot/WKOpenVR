...
function Assert-InstalledState {
    ...
    $expected = @(
        ...
        (Join-Path $InstallDir 'action_manifest.json'),
        (Join-Path $InstallDir 'bindings_dashboardinput_knuckles.json'),
        (Join-Path $InstallDir 'bindings_dashboardinput_touch.json'),
        (Join-Path $InstallDir 'bindings_dashboardinput_vive.json'),
        (Join-Path $InstallDir 'bindings_dashboardinput_generic.json'),
